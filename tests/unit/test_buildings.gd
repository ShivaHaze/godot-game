...
func test_data_and_cells() -> void:
	...
	assert_eq(data.building_order, ["wood_wall", "wood_door", "stone_wall", "anchor", "trade_table", "sensor", "trap", "turret", "sign", "campfire", "spawn_anchor", "depot", "mine", "bomb"] as Array[String])
