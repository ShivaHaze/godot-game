...
server/              Headless-Server: net_server.gd (ENet, Absichten rein, Snapshots raus, Trennen = NPC), server_runner.gd (Welt laden, Füllung,
                     Tick, Speichern – für Skript und Programm), server_main.gd (Startskript `-s`)
